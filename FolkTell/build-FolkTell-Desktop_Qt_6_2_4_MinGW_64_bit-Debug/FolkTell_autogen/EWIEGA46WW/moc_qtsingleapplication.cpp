...
#include <memory>
#include "../../../FolkTell/qtsingleapplication.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QtSingleApplication_t, stringdata0) + ofs), len 
...
const QMetaObject QtSingleApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_QtSingleApplication.offsetsAndSize,
