...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PageView_t, stringdata0) + ofs), len 
...
const QMetaObject PageView::staticMetaObject = { {
    ...
    qt_meta_stringdata_PageView.offsetsAndSize,
    qt_meta_data_PageView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_PageView_t
